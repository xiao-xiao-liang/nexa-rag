...
CREATE TABLE IF NOT EXISTS document (
    ...
    active_version_id BIGINT NULL COMMENT '当前生效文档版本ID',
    building_version_id BIGINT NULL COMMENT '正在构建的文档版本ID',
    activation_generation BIGINT NOT NULL DEFAULT 0 COMMENT '生效代次',
    ...
    KEY idx_document_active_version (active_version_id),
    KEY idx_document_building_version (building_version_id),
    KEY idx_document_knowledge_base_del_flag (knowledge_base_id, del_flag)
) COMMENT='文档表';
...
CREATE TABLE IF NOT EXISTS document_task_outbox (
    ...
    KEY idx_document_task_outbox_version (document_id, document_version_id, task_type, task_status)
...
CREATE TABLE IF NOT EXISTS document_chunk (
    ...
    document_id BIGINT NOT NULL COMMENT '文档ID',
    document_version_id BIGINT NULL COMMENT '所属文档版本ID',
    ...
    KEY idx_document_chunk_version (document_id, document_version_id)
) COMMENT='文档片段表';
...
CREATE TABLE IF NOT EXISTS document_section (
    ...
    KEY idx_document_section_version (document_id, document_version_id)
) COMMENT='文档章节结构表';
