...
class DocumentPipelineMessageTest {
    ...
    void shouldRejectNonPositiveDocumentId() {
        assertThatThrownBy(() -> new DocumentPipelineMessage(0L, "process-001", 1, CREATED_TIME))
    ...
    void shouldRejectBlankProcessId() {
        assertThatThrownBy(() -> new DocumentPipelineMessage(1L, " ", 1, CREATED_TIME))
                .isInstanceOf(IllegalArgumentException.class)
    ...
    void shouldRejectNonPositiveSchemaVersion() {
        assertThatThrownBy(() -> new DocumentPipelineMessage(1L, "process-001", 0, CREATED_TIME))
                .isInstanceOf(IllegalArgumentException.class)
    ...
    void shouldRejectNullCreatedTime() {
        assertThatThrownBy(() -> new DocumentPipelineMessage(1L, "process-001", 1, null))
                .isInstanceOf(IllegalArgumentException.class)
