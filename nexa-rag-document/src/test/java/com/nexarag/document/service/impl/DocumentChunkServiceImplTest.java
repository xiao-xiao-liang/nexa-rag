...
class DocumentChunkServiceImplTest {
    ...
    @Test
    void replaceDocumentVersionChunksShouldRollbackWhenAnyStepFails() throws NoSuchMethodException {
        Transactional transactional = DocumentChunkServiceImpl.class
                .getMethod("replaceDocumentVersionChunks", Long.class, Long.class, List.class)
    ...
    void toChunkShouldRejectBlankIndexContent() throws Exception {
        ...
        assertThatThrownBy(() -> method.invoke(service, 1L, null, draft, 0))
    ...
    void toChunkShouldKeepSectionAndIndexContent() throws Exception {
        ...
        assertThat(result.getDocumentVersionId()).isEqualTo(2L);
